...
def encode_text(text):
    ...
    # Adjust to filter out tokens with index >= VOCAB_SIZE
    tokens = [tokenizer.word_index.get(word, 0) if tokenizer.word_index.get(word, VOCAB_SIZE) < VOCAB_SIZE else 0 for word in tokens]
